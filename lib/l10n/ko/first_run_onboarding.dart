...
class FirstRunOnboardingTexts implements FirstRunOnboardingTextSet {
  ...
  String get subtitle => '식사 시간을 부담 없는 작은 주행으로 바꿔요.';
  ...
  List<FirstRunOnboardingSlideText> get slides => const [
    FirstRunOnboardingSlideText(
      ...
      body:
          '아이에게 한 입만 더 권하다 보면 부모도 지치고, 아이도 식사 시간이 부담스러워질 때가 있어요. 냠냠 라이더는 재촉 대신 작은 코스를 따라가는 식사 흐름을 만들어줘요.',
      bullets: ['아이가 시간을 눈으로 느껴요.', '부모의 반복적인 재촉을 줄여요.', '오늘의 작은 시도를 응원해요.'],
    ),
    FirstRunOnboardingSlideText(
      emoji: '🚗',
      title: '식사 시간을 작은 라이딩으로',
      body:
    ...
    FirstRunOnboardingSlideText(
      emoji: '🌱',
      title: '완벽하지 않아도 괜찮아요',
      body: '냠냠 라이더는 아이를 평가하는 앱이 아니에요. 오늘의 식사 흐름을 조금 더 부드럽게 도와주는 도구예요.',
      bullets: [
        '일시정지는 실패가 아니에요.',
