...
class UserGuideTexts implements UserGuideTextSet {
  ...
  List<String> get roadIngredientsItems => const [
    ...
    '직접 선택: 코스 시작 전 최대 5개까지 고르고, 직접 고른 식재료가 식사 기록에 남아요.',
  ...
  List<String> get completionItems => const [
    ...
    '타이머가 먼저 도착했는데 식사가 끝나지 않았으면 “아직 아니에요”를 눌러 미완료로 기록할 수 있어요.',
  ...
  List<String> get historyRewardsItems => const [
    '식사 기록에서 목표 시간, 실제 시간, 완료 상태, 받은 스티커, 직접 고른 식재료를 볼 수 있어요.',
  ...
  List<String> get exitResumeItems => const [
    ...
    '진행 중인 타이머가 저장되어 있으면 홈에 진행 중인 타이머 카드가 표시되고, 이어가거나 취소할 수 있어요.',
  ];
