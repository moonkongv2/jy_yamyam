...
class EnMealHistoryTexts implements MealHistoryTextSet {
  ...
  List<String> get helpBulletItems => const [
    'Meal history shows target time, actual time, completion status, and earned vehicle stickers.',
